...
// page must never break just because it got renamed. Every category is an
// ordinary, fully user-owned row now — no more curated/built-in tier to
// carve out an exception for (see the removed getCategoryBySlug check this
// used to have).
...
// No more curated/built-in exception here either - every category, no
// matter which one, can be deleted through the app now.
