...
- [ ] Build `getSeatUsage(orgId)` — counts active members, owner included, against the plan's seat allowance
...
No organization, category, or membership row for any *future* workspace
is ever created outside the app's own code paths.
